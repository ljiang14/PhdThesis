...
%    top color=white, bottom color=blue!20}]]
  every node/.style = {shape=rectangle, rounded corners,
    draw, align=center}]]
  \node[top color=red!20, bottom color=blue!20, font = \sffamily] {Guaranteed Automatic Integration Library}
