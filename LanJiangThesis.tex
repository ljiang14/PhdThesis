...
\end{equation}
where $\kmax$ is some bound defined in Definition \ref{def:kmax}, we present several algorithms that estimate the mean, $\mu$, of a random variable, $Y$, that satisfies the fixed width confidence interval condition with some prescribed absolute error tolerance $\varepsilon_a$,  
